# UiPathStudio 22.10.4

Welcome to the UiPathStudio 22.10.4 Chocolatey Package!
...
## Installation of UiPathStudio 22.10.4

To install UiPathStudio 22.10.4 using Chocolatey, follow these steps:
...
2. **Run the Chocolatey Installation Command:** Copy and paste the following command into the command prompt and press Enter:
   ...
   - For the **test** source:
     ...
     ```shell
     choco install uipathstudio --version 22.10.4 --source https://www.myget.org/F/project-basturma-chocolatey-beta/api/v2
     ```

   - For the **prod** source:
     ```shell
     choco install uipathstudio --version 22.10.4 --source https://www.myget.org/F/project-basturma-chocolatey-packages/api/v2
     ```

   This command will instruct Chocolatey to download and install UiPathStudio version 22.10.4.
...
To uninstall UiPathStudio 22.10.4 using Chocolatey, run the following command in an elevated command prompt:

```shell
choco uninstall uipathstudio --version 22.10.4
```
